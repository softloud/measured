...
time_tracker %>%
  ...
  geom_density(alpha = 0.7, colour = "darkgrey", fill = "darkgrey") +
...
time_tracker %>%
  ...
  ggplot(aes(x = hrs)) + 
 geom_vline(linetype = "dotted", xintercept = 4 / 3) +
  geom_density(alpha = 0.7, colour = "darkgrey", fill = "darkgrey") +  facet_grid(category ~ month, scales = "free") +
  labs(title = "2018",
       caption = "test")
