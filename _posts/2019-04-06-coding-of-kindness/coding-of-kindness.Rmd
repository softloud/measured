...
I think the focus needs to shift from conduct to community, support, and inclusivity. The problem with the term conduct, is it focussed on the perpetrator’s _doing_. We are not in the business of policing people. We should support people in making complaints to the police about serious cases of abuse and harassment, rather than trying to do their job for them. Indeed, it is very important that complaints are formal, so that the weight of evidence builds in the public record. 
